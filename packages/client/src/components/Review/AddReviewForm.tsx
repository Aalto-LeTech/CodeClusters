...
const AddReviewFormEl = memo(
  forwardRef((props: IProps, ref: any) => {
    ...
    useImperativeHandle(
      ref,
      () => ({
        executeSubmit: (defaultData?: IReviewCreateFormParams) =>
      ...
      <Form className={className} onSubmit={handleSubmit(onSubmitForm)}>
        <FormField>
          ...
          <Input
            ...
            ref={register}
          />
          <Error>{errors.message && 'Message must be between 1 to 10240 characters.'}</Error>
        </FormField>
        <FormField>
          ...
          <Input
            ...
            ref={register}
          />
          <Error>{errors.metadata && 'Metadata must be less than 10240 characters.'}</Error>
        </FormField>
        <FormField>
