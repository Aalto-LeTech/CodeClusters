    ...
    <Wrapper className={className}>
      <Container>
        <Header>
          ...
          <p>
            CodeClusters was a thesis project originally authored by Teemu Koivisto for Aalto University's LeTech research group during the year 2020.
          </p>
        </Header>
        <Divider />
        <Article>
          ...
          <p>
            ...
            Solr. Automation in this matter has not been finalized yet, but in theory the ingestion of new data to CodeClusters
            should be seamless. Currently the only data at hand is the example dataset of MarsinLampotilanKeskiarvo.
          </p>
          <p>
          ...
          <p>
            Using the search results list, the desired submissions can be selected and a review can be created. After accepting the
            reviews from the /reviews page, they should be sent to the students albeit the integration to current LMS systems is still missing. 
            But in the future the students should be able to view their received reviews by logging in with their respective student accounts
            to the system.
          </p>
          <h2>Search</h2>
          <p>
